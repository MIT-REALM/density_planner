...
def parse_args():
    ...
    parser.add_argument('--nameend_rawdata', type=str,
                        default="rawData_CAR_iter100_xSamples20_tSamples10.pickle")  # ending of the file used for creating the data set / dataloader
    parser.add_argument('--nameend_dataset', type=str,
                        default="files173_CAR_iter100_xSamples20_tSamples10.pickle")
    ...
    parser.add_argument('--name_pretrained_nn', type=str,
                        default="data/trained_nn/2022-04-21-21-04-14_NN_newCost_CAR_dt10ms_Nsim100_Nu10_iter1000.pt")  # location and name for the pretrained NN which is supposed to be loaded
    ...
    parser.add_argument('--size_hidden', type=int, nargs="+", default=[64, 64, 64, 64])

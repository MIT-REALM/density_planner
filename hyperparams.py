...
def parse_args():
    ...
    # data paths
    parser.add_argument('--path_rawdata', type=str, default="data/rawdata/2022-05-22_filesTrain_discr10MoreD/")  # directory for the density data
    ...
    parser.add_argument('--name_pretrained_nn', type=str,
                        default="data/trained_nn/2022-05-26-16-19-09_NN_normal_lr0.0001_numHidd4_sizeHidd100_rhoLoss0.01.pt")  # location and name for the pretrained NN which is supposed to be loaded
    ...
    # NN parameter
    parser.add_argument('--run_name', type=str, default="bigDataset")

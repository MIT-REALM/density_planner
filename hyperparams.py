...
def parse_args():
    ...
    # data paths
    parser.add_argument('--path_rawdata', type=str, default="data/rawdata/2022-04-22_filesVal/")  # directory for the density data
    ...
    parser.add_argument('--name_pretrained_nn', type=str,
                        default="data/trained_nn/2022-04-23-19-27-52_NN_xe_3layers_lr0.001_numHidd3_sizeHidd64_rhoLoss0.1.pt")  # location and name for the pretrained NN which is supposed to be loaded
    ...
    # NN parameter
    parser.add_argument('--run_name', type=str, default="minXRho")
